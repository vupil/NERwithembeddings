...
// To read from file
// ----------------------------------------------------------------------
OWLOntology GOOntology = manager.loadOntologyFromOntologyDocument(new File("/Users/vipul2310/Google Drive (vm2583@columbia.edu)/Eli Lilly/risk grids/riskOntoNewUpdate2.owl"));
...
//Infer subclass/equivalent/disjoint axioms using reasoner: THE TYPES OF AXIOMS TO EXTRACT/INFER FROM THE ONTOLOGY
...
for (OWLClass class1 : classes)
{
   ...
   for (OWLClassAxiom claxiom: ontoaxioms)
    ...
    out.flush()  // to force write to file
    out1.flush()  // to force write to file
